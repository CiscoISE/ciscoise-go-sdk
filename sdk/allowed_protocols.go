...
type ResponseAllowedProtocolsGetAllowedProtocolByNameAllowedProtocolsEapFast struct {
	...
	EapFastUsePacsServerReturns                   *bool  `json:"eapFastUsePacsServerReturns,omitempty"`                   // The eapFastUsePacsServerReturns is required only if eapFastUsePacsAllowAuthenProvisioning is true, otherwise it must be ignored	EapFastUsePacsAcceptClientCert                                 *bool  `json:"eapFastUsePacsAcceptClientCert,omitempty"`                                 // The eapFastUsePacsAcceptClientCert is required only if eapFastUsePacsAllowAuthenProvisioning is true, otherwise it must be ignored
